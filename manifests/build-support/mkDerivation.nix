...
let
  ...
  # Spago versions < 0.93.45 require Node.js 20 due to better-sqlite3 build
  # issues with Node 22+. Spago 0.93.45+ works with the standard nodejs.
  # See: https://github.com/purescript/registry-dev/blob/87c5900ff6fb7090cf2b085b7eb3f75371560522/nix/overlay.nix#L152
  needsNode20 = isSpago && builtins.compareVersions version "0.93.45" < 0;

  selectedNodejs = if needsNode20 then nodejs_20 else nodejs;
